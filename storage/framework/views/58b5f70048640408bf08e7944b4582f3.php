<?php $__env->startSection('content'); ?>
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
            <form action="<?php echo e(route('update-dokter',['id'=>$data->id])); ?>" method="POST">
                <?php echo csrf_field(); ?>
                            ...
                            <form>
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama" class="form-control" id="exampleInputDokter1" value="<?php echo e($data->nama); ?>"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="no_hp"  class="form-control" id="exampleInputNoHp1" value="<?php echo e($data->no_hp); ?>"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="password"  class="form-control" id="exampleInputPassword1" value="<?php echo e($data->password); ?>"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="exampleInputRuangPoli" name="id_poli" required>
...
<?php echo $__env->make('components.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\poli\resources\views\admin\edit-dokter.blade.php ENDPATH**/ ?>