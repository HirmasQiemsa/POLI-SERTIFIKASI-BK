                    ...
                    <div class="row">
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-success">
                                ...
                                <a href="<?php echo e(route('login-pasien')); ?>" class="small-box-footer">Login Pasien   <i
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-info">
                                ...
                                <a href="<?php echo e(route('login-dokter')); ?>" class="small-box-footer">Login Dokter   <i
                                        class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-warning">
                                ...
                                <a href="<?php echo e(route('login-admin')); ?>" class="small-box-footer">Login Admin   <i
                                        class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
...
<?php /**PATH C:\laragon\www\poli\resources\views/beranda.blade.php ENDPATH**/ ?>