            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info d-flex">
                        <a href="#" class="d-flex">Hallo, Dokter</a>
                    </div>
                </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="tree" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('dashboard-dokter')); ?>" class="nav-link">
...
<?php /**PATH C:\laragon\www\poli\resources\views\components\dokter.blade.php ENDPATH**/ ?>