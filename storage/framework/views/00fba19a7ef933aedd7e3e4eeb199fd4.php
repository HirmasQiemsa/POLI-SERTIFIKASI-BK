    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <a href="<?php echo e(url('/')); ?>" class="h1"><b>LOGIN Pasien</b></a>
            </div>
            <div class="card-body">
                <h2 class="login-box-msg">UDINUS Poli Klinik</h2>

                <form action="<?php echo e(route('login-proses-pasien')); ?>" method="post">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row mt-3">
                        ...
                        <!-- /.col -->
                        <p class="col-6 m-2">
                            <a href="<?php echo e(route('register')); ?>" class="text-center">Registrasi Pasien</a>
                        </p>
                    </div>
                </form>
...
<?php /**PATH C:\laragon\www\poli\resources\views/pasien/login.blade.php ENDPATH**/ ?>