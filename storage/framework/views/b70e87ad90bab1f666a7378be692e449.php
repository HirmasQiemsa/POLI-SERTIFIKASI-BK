...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info d-flex">
                        <a href="#" class="d-flex">Admin - <?php echo e($admin->nama); ?></a>
                    </div>
                </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('kelola-dokter')); ?>" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('kelola-pasien')); ?>" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('kelola-obat')); ?>" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('kelola-poli')); ?>" class="nav-link">
        ...
        <footer class="main-footer">
            <strong>Bimbingan Karir &copy; 2014 <a href="#">Poli Klinik</a>.</strong>
...
<?php /**PATH C:\laragon\www\poli\resources\views\components\admin.blade.php ENDPATH**/ ?>