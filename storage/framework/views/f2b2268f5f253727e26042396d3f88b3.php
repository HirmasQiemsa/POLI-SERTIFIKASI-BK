    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <a href="<?php echo e(url('/')); ?>" class="h1"><b>LOGIN Admin</b></a>
            </div>
            <div class="card-body">
                <h2 class="login-box-msg">UDINUS Poli Klinik</h2>

                <form action="<?php echo e(route('login-proses-admin')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    <div class="input-group mt-3">
                        <input type="text" name="nama" class="form-control" placeholder="Username Admin">
...
<?php /**PATH C:\laragon\www\poli\resources\views/admin/login.blade.php ENDPATH**/ ?>