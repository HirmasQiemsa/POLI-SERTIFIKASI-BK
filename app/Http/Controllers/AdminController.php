...
class AdminController extends Controller
{
    ...
    public function kelola_dokter()
    {
        ...
        // $ruangan = Dokter::with('ruangPoli')->get();
        return view('admin.kelola-dokter',compact('admin','data'));
    }
    public function kelola_pasien()
    {
        ...
        $admin = Admin::find($adminId);
        $data = Pasien::get();
        return view('admin.kelola-pasien',compact('admin','data'));
    }
    public function kelola_obat()
    {
        ...
        $admin = Admin::find($adminId);
        $data = Obat::get();
        return view('admin.kelola-obat',compact('admin','data'));
    }
